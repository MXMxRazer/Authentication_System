...
import RegisterForm from './formController';
...
function Login(): JSX.Element {
    return (
        <div
            className={
                `w-full m-2 flex justify-center flex-col p-4`
            }>
            <span
                className={
            ...
            <div
                className={
                    `mt-2 border-2 rounded-lg w-7/12 m-auto p-6 pb-8 flex gap-6 shadow-md shadow-white`
                }
            >
                {loginSideImage()}
                <RegisterForm />
